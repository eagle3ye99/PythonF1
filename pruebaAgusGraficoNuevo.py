...
if sessions_data:
    ...
    if not laps_df.empty:
        ...
        print("\nCreating bar chart of fastest laps (relative to fastest driver)")

        # Asegura que todos los colores tengan el prefijo '#'
        ...
        # Cambia la escala del eje x cada 0.1 segundos (100 milisegundos)
        ...
        plt.show()
        print("Bar chart of fastest laps saved as: f1_fastest_lap_bar_chart.png")
    else:
